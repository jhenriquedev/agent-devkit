...
class ValidateRepoTest(unittest.TestCase):
    ...
    def test_current_repo_passes_default_validation(self) -> None:
        ...
        self.assertEqual(payload["agents"]["execution-reviewer"]["missing_decision_rules"], 0)
        ...
        self.assertEqual(payload["agents"]["local-llm-operator"]["missing_decision_rules"], 0)
        ...
        self.assertEqual(payload["agents"]["provider-configurator"]["missing_decision_rules"], 0)
        ...
        self.assertEqual(payload["agents"]["task-orchestrator"]["missing_decision_rules"], 0)
