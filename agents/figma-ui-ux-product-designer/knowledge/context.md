...
- Criar ou evoluir design no Figma quando a integracao estiver disponivel.
...
- Escrita real no Figma depende de MCP/conector do ambiente.
- Sem MCP, o agente opera em `plan_only`.
