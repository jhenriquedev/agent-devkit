#!/usr/bin/env python3
"""Runner for supabase-project-analyst/review-migrations."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Review Supabase migrations")
    parser.add_argument("--project-path", default=".")
    args = parser.parse_args()
    try:
        result = SupabaseProjectRepository().review_migrations(project_path=Path(args.project_path))
