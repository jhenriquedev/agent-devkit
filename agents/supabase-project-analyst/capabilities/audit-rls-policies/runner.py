#!/usr/bin/env python3
"""Runner for supabase-project-analyst/audit-rls-policies."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Audit Supabase RLS policies")
    parser.add_argument("--project-path", default=".")
    args = parser.parse_args()
    try:
        result = SupabaseProjectRepository().audit_rls_policies(project_path=Path(args.project_path))
