...
- Se uma fonte essencial falhou → registre como pergunta aberta, não prossiga para
  geração às cegas.
- Se failed_sources contém apenas arquivos irrelevantes → registre como aviso e
  continue.
