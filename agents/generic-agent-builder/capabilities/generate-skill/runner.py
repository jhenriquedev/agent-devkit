#!/usr/bin/env python3
"""Runner for generic-agent-builder/generate-skill."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate a portable SKILL.md")
    parser.add_argument("--spec", required=True)
    args = parser.parse_args()

    try:
        result = GenericAgentRepository().generate_skill(spec_path=Path(args.spec))
