...
```bash
./ai-devkit run azure-devops-orchestrator gerar-relatorio-cards --project <project> --state "To Do" --limit 50 --include-comments
```

Com fixture:

```bash
./ai-devkit run azure-devops-orchestrator gerar-relatorio-cards --fixture <fixture.json>
```
