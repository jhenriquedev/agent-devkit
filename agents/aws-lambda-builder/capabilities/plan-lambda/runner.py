#!/usr/bin/env python3
"""Runner for aws-lambda-builder/plan-lambda."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Plan an AWS Lambda project")
    parser.add_argument("--spec", required=True)
    args = parser.parse_args()

    try:
        result = AwsLambdaRepository().plan_lambda(spec_path=Path(args.spec))
