#!/usr/bin/env python3
"""Runner for playwright-automation-builder/run-playwright-check."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run a controlled Playwright check")
    ...
    try:
        result = PlaywrightAutomationRepository().run_playwright_check(
