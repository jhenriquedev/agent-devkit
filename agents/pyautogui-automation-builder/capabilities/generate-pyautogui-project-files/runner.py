#!/usr/bin/env python3
"""Runner for pyautogui-automation-builder/generate-pyautogui-project-files."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate PyAutoGUI automation project files")
    ...
    try:
        result = PyAutoGUIAutomationRepository().generate_pyautogui_project_files(
